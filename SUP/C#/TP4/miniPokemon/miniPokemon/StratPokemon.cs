...
namespace miniPokemon
{
    ...
    public class StratPokemon
    {
        ...
        public StratPokemon(Pomon pokemon, string name)
        {
            ...
            {
                {Pomon.AlakazamMega, new Stats {HP = 55, Atk = 50, Def = 65, SpA = 175, SpD = 105, Spe = 150, Type1 = Poketype.PSYCHIC, Attack1 = new Move(Attack.Psychic), Attack2 = new Move(Attack.FocusBlast), Attack3 = new Move(Attack.ShadowBall), Attack4 = new Move(Attack.CalmMind)}},
                {Pomon.Blacephalon, new Stats {HP = 53, Atk = 127, Def = 53, SpA = 151, SpD = 79, Spe = 107, Type1 = Poketype.FIRE, Type2 = Poketype.GHOST, Attack1 = new Move(Attack.ShadowBall), Attack2 = new Move(Attack.Flamethrower), Attack3 = new Move(Attack.FireBlast), Attack4 = new Move(Attack.Overheat)}},
