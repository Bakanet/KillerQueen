...
namespace miniPokemon
{
    public static class Fight
    {
        ...
        public static void CreateTeam()
        {
            ...
            for (int i = 1; i <= 6; i++)
            {
                Console.Write("Choose the Pokemon " + i + " (enter a number) : ");
                string temp = "0";
                while (int.Parse(temp) < 1 || int.Parse(temp) > 7)
                {
                    while ((temp = Console.ReadLine()) == "") ;
                    if (int.Parse(temp) < 1 || int.Parse(temp) > 7)
                    {
        ...
        public static void Turn()
        {
            ...
            MoveStats attack1 = Move.PokeAttack[Team1[0].Poke[Team1[0].Pokemon].Attack1],
                attack2 = Move.PokeAttack[Team1[0].Poke[Team1[0].Pokemon].Attack2],
                attack3 = Move.PokeAttack[Team1[0].Poke[Team1[0].Pokemon].Attack3],
                attack4 = Move.PokeAttack[Team1[0].Poke[Team1[0].Pokemon].Attack4];
            ...
            while (team1Alive > 0 || team2Alive > 0)
            {
                ...
                if (int.Parse(move1) == 1)
                {
                    team1Damages = Move.Damages(team1.Atk, team1.SpA, team2.Def, team2.SpD,
                        attack1.Kind, team1.Type1, team1.Type2, attack1.Type, team2.Type1, team2.Type2);
                }

                if (int.Parse(move1) == 2)
                {
                    team1Damages = Move.Damages(team1.Atk, team1.SpA, team2.Def, team2.SpD,
                        attack2.Kind, team1.Type1, team1.Type2, attack2.Type, team2.Type1, team2.Type2);
                }

                if (int.Parse(move1) == 3)
                {
                    team1Damages = Move.Damages(team1.Atk, team1.SpA, team2.Def, team2.SpD,
                        attack3.Kind, team1.Type1, team1.Type2, attack3.Type, team2.Type1, team2.Type2);
                }

                if (int.Parse(move1) == 4)
                {
                    team1Damages = Move.Damages(team1.Atk, team1.SpA, team2.Def, team2.SpD,
                        attack4.Kind, team1.Type1, team1.Type2, attack4.Type, team2.Type1, team2.Type2);
                }
                ...
                if (int.Parse(move2) == 1)
                {
                    team2Damages = Move.Damages(team2.Atk, team2.SpA, team1.Def, team1.SpD,
                        attack1.Kind, team2.Type1, team2.Type2, attack1.Type, team1.Type1, team1.Type2);
                }

                if (int.Parse(move2) == 2)
                {
                    team2Damages = Move.Damages(team2.Atk, team2.SpA, team1.Def, team1.SpD,
                        attack2.Kind, team2.Type1, team2.Type2, attack2.Type, team1.Type1, team1.Type2);
                }
